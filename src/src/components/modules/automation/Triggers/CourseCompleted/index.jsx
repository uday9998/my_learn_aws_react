...
const CourseCompleted = ({
   onClose, courses, handleInputChange, saveTrigger, currentTrigger,
}) => {
   ...
   const saveTriggerFunc = () => {
      ...
      saveTrigger({ type: 'course_complete', course_id: currentTrigger.course_id, id: currentTrigger.id });
   };
