...
const formatReorderData = sections => sections
...
function SectionSortableList({ sections, onChange, children }) {
   function onDragEnd(result) {
      ...
      if (result.type === 'droppableItem') {
         const items = reorder(sections, sourceIndex, destIndex);
                     ...
                     <Draggable key={ item.id } draggableId={ String(item.id) } index={ index }>
                        {(p, s) => (
                           <div className='courseSectionWrap'>
                              {children(p, s, item, getItemStyle)}
                           </div>
                        )}
                     </Draggable>
                  ))}
...
export default SectionSortableList;
