...
const QuizAnswer = ({
   index, description, isTrue, onChange,
}) => {
   ...
   return (
      ...
      >
         <div className={ description ? 'quizItem_number quizItem_number_filled' : 'quizItem_number' }>
            <Text
               inner={
               ...
               style={ isTrue ? { color: 'var(--buttonBgcolor)' } : description ? { color: '#131F1E' } : { color: ' #A1A5A5' } }
            />
         </div>
