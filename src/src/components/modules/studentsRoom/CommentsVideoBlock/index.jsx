...
const CommentsVideoBlock = ({
   ...
   return (
      <div className='commentsVideoBlock'>
         <div className='commentCount'>Comments ({comments ? comments.length : 0})</div>
         {commentStatus === 2 && <div className='commentsLocked' />}
         <div
            className='commentsVideoBlock__comments'
            ref={ commentsBlock }
            onScroll={ handleOnScroll }
         >
            {commentStatus === 1 && (
               <div className='commentsVideoBlock__comments__member'>
                  <MemberComment
                     textColor={ textColor }
               ...
               return (
                  <div
                     ...
                     className={ classnames({
                        'commentsVideoBlock__newComment': comment.new,
                        'commentsVideoBlock_deleteComment': comment.delete,
                     }) }
                  >
                     <CommentField
...
CommentsVideoBlock.defaultProps = {
   comments: [],
   user: {},
   textColor: '#7cb740',
};

export default CommentsVideoBlock;
