...
class AffilatesContainer extends Component {
   static propTypes = {
   ...
   render() {
      return (
         ...
         >
            ...
            >
               Hello from Admin Promotions - Affilates
               <br />
...
export default connect(mapStateToProps, mapDispatchToProps)(AffilatesContainer);
