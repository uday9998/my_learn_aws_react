...
const EmailsCreateContainer = ({
   match, filterByCourses, setInputAction, getAdminsEmails, getAllUsersEmails,
   filterByTags, formData, getFilterOptionsInProgress, emails,
   filterOptions, addFilterOptionAction, filterByTagsEmails,
   removeFilterOptionAction, selectedFilters, getAdminEmailsInProgress,
   filterEmails, sendEmail, resetInputAction, authUser, siteInfo,
}) => {
   ...
   const [email, setEmail] = useState({
      blocks: [
         {
            ...
            css_attributes: {
               'bg_color': 'inherit',
               'paddingTop': 4,
               'description': "<p class='clicked__element' style=\"text-align: left;\">Hey [%user_name%],</p>\n<p style=\"text-align: left;\">&nbsp;</p>\n<p style=\"text-align: left;\">Get ready to be whisked away on a whirlwind journey with [%site_title%]! Our brand new video series premieres this [Day of the week] at [Time] and you won't want to miss it.</p>\n<p style=\"text-align: left;\">&nbsp;</p>\n<p style=\"text-align: left;\">Think [brief, intriguing description of the program's content]. Buckle up for [mention some exciting elements or topics covered].</p>\n<p style=\"text-align: left;\">&nbsp;</p>\n<p style=\"text-align: left;\">Here's a sneak peek of what awaits:</p>\n<p style=\"text-align: left;\">&nbsp;</p>\n<p style=\"text-align: left;\">[Snippet of episode 1 or a highlight]</p>\n<p style=\"text-align: left;\">[Snippet of episode 2 or another highlight]</p>\n<p style=\"text-align: left;\">[Mention a special guest or unique aspect]</p>\n<p style=\"text-align: left;\">Intrigued? We thought so!</p>\n<p style=\"text-align: left;\">&nbsp;</p>\n<p style=\"text-align: left;\">Click here to login and access: [%sign_in_url%]</p>\n<p style=\"text-align: left;\">&nbsp;</p>\n<p style=\"text-align: left;\">See you there!</p>\n<p style=\"text-align: left;\">&nbsp;</p>\n<p style=\"text-align: left;\">P.S. Share this email with your fellow curious comrades and spread the word! The more, the merrier!</p>\n<p style=\"text-align: left;\">&nbsp;</p>\n<p style=\"text-align: left;\">P.P.S. We have a special surprise for early viewers... Stay tuned!</p>\n<p style=\"text-align: left;\">&nbsp;</p>\n<p style=\"text-align: left;\">Best,</p>\n<p style=\"text-align: left;\">&nbsp;</p>\n<p style=\"text-align: left;\">[%owner_name%]</p>",
               'letterSpacing': 1,
               'paddingBottom': 4,
               'paddingRight': 20,
               'paddingLeft': 3,
      ...
      css_attributes: {
         bg_color: '#ffffff', brand_color: '#6127FD', paddingTop: '64', paddingBottom: '64', paddingRight: '64', paddingLeft: '64',
      },
      footer_text: `Copyright © ${ new Date().getFullYear() } by ${ siteInfo.title }`,
   });
   ...
   const handleSave = (sendType, date) => {
      ...
      if (date) {
         ...
         const dateUserTimeZone = momentTimezone.tz(date, userTimeZone);
         const dateUTC = dateUserTimeZone.utc().format('YYYY-MM-DD, HH:mm:ss z');
         body = { ...body, scheduled_date: dateUTC };
      }
      if (sendType === 'test') {
...
EmailsCreateContainer.propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(EmailsCreateContainer);
