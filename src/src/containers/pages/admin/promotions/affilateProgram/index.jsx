...
class AffilateProgramContainer extends Component {
   static propTypes = {
   ...
   render() {
      return (
         ...
         >
            ...
            >
               Hello from Admin Promotions - Affiliate Program
               <br />
...
const mapStateToProps = (state) => {
   return { authUser: authUserSelector(state) };
};
...
export default connect(mapStateToProps, mapDispatchToProps)(AffilateProgramContainer);
