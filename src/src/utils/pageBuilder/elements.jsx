   ...
   return (
      {
         ...
         name: 'Image',
         props: {
            picture_src: 'https://miestro-production.s3-us-west-2.amazonaws.com/landing/mask.jpg',
            width: '310',
            paddingTop: '5',
            paddingBottom: '5',
            paddingLeft: '5',
...
export const CheckoutDividerData = () => {
   return {
      slug: slug(),
      type: 'divider',
      name: 'Divider',
...
export const DividerData = (classSlug) => {
   return {
      slug: classSlug(1),
      type: 'divider',
      name: 'Divider',
