...
const AffiliateStats = () => {
   const { stats, filterType, onChangeFilterType } = useContext(MainAffiliateContext);
   const filters = {
      today: 'Today',
      yesterday: 'Yesterday',
      this_week: 'This week',
   ...
   return (
      <div className='affiliate__stats affiliate__stats__user'>
         ...
         <div className='affiliate__stats__data'>
            ...
            <div className='affiliate__stats__data__block'>
               <Text
                  inner={ `${ stats.affiliatesFilterCount }` }
                  type={ types.mediumSmall }
                  size={ sizes.xxlarge }
                  style={ { marginBottom: '8px' } }
               />
