...
const Multiple = ({
   ...
   return (
      <div className='general__quiz__multiple'>
         ...
         {isRight && (
            <div className='general__quiz__multiple__contentRigth'>
               <div>
                  <Text
                     inner='Settings'
               ...
               <div className='general__quiz__multiple__content__img'>
                  <Switch
                     label='Required'
               ...
               <div className='general__quiz__multiple__contentRigth__img'>
                  <Switch
                     label='Image'
