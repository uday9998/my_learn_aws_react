...
const UpsellEditText = ({
   props, changeProp, component, sectionIndex, handleDeleteComponent,
}) => {
   const {
      text, paddingTop, paddingBottom, paddingLeft, paddingRight, color,
   ...
   return (
      <div className='upsell__edit__text'>
         {/* <Input
            value={ text }
            name='text'
            label='Text'
