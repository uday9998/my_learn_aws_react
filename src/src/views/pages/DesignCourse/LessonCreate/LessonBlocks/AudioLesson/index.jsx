   ...
   return (
      <div className='pdf__lesson'>
         <UploadMediaView
            ...
            buttonText='Audio'
            iconName='audioM'
            bottomText='You can upload audio files with the extension .mp3 or .ogg'
            uploadProps={ {
               fileLessonFormat: 'audio',
               isAmazonFile: true,
               //  cropRatio: '1920x1080',
               onChange: (value, originalName, file) => changeLesson('audio_src', value, originalName, file),
            } }
            view={ (
               <AudioItem
                  file={ block.audio_src }
                  name={ block.name }
                  autoplay={ autoplay }
               />
            ) }
