      ...
      >
         ...
         <div className='quizItem_form'>
            ...
            <div className='quizItem_input'>
               ...
               && (
                  <div className='quizItem_delete' role='presentation' onClick={ (block, questionId, answer, questionIndex) => handleDeleteAnswer(block, questionId, answer, questionIndex) }>
