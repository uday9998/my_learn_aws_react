...
const UnsubscribeSuccessTemplateOneBottom = ({ generalProps, previewMode }) => {
...
UnsubscribeSuccessTemplateOneBottom.propTypes = {
   generalProps: PropTypes.object,
   previewMode: PropTypes.bool,
};

export default UnsubscribeSuccessTemplateOneBottom;
